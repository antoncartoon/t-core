                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="text-xl sm:text-2xl font-bold text-foreground mb-1">
                      {stat.label === 'Total TDD Staked' ? (
                        ...
                        <AnimatedCounter end={TCORE_STATS.activeStakers} decimals={0} />
                      ) : stat.label === 'Self-Insurance Pool' ? (
                        <AnimatedCounter end={TCORE_STATS.selfInsurancePool / 1000} prefix="$" suffix="K" decimals={0} />
                      ) : (
                        stat.value
                      )}
                    </div>
