  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <Tabs defaultValue="deposit" className="space-y-8 sm:space-y-12">
          ...
          <TabsContent value="deposit" className="space-y-8 sm:space-y-12">
          ...
          <TabsContent value="stake" className="space-y-8 sm:space-y-12">
